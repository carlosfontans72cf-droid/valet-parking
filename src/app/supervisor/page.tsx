  ...
  return (
    <div className="min-h-screen bg-gray-900 p-4">
      <div className="max-w-2xl mx-auto">
        ...
        {/* Acciones directas - como el menú valet */}
        ...
        {/* Link al panel Dueño si es Dueño (no mostrar si es solo supervisor) */}
        <div className="text-center mt-4">
          <button onClick={() => window.location.href = "/dueno"} className="text-blue-400 text-sm underline">Ir al panel de Dueño →</button>
        </div>
      </div>
    </div>
  );
