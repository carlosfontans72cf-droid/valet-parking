...
export default function CambioPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 p-4 pb-8">
      <div className="flex items-center gap-3 mb-6"><button onClick={()=>window.location.href="/valet"} className="text-gray-400 text-3xl">←</button><h1 className="text-white text-xl font-bold">🔄 Cambiar</h1></div>
